...
RSpec.describe "As a Visitor" do 
  ...
  it "Can unfavorite pets" do 
    ...
    expect(current_path).to eq("/favorites")
    expect(page).to have_content("You do not have any favorites. Please go to a shelter and add pets to your favorites.")
  end

  it "Can delete all pets at once" do
    visit "/shelters/#{@adams_county.id}/pets"
